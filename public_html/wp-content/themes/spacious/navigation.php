...
if ( is_single() ) {
	...
	?>
		<ul class="default-wp-page clearfix">
			<li class="previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Anterior', 'spacious' ) . '</span> %title' ); ?></li>
			<li class="next"><?php next_post_link( '%link', '%title <span class="meta-nav">' . _x( '&rarr;', 'Próximo', 'spacious' ) . '</span>' ); ?></li>
		</ul>
	<?php
	}	
}
